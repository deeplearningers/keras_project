...
def SSD300(input_shape, num_classes=21):
    ...
    # FC7
    net['fc7'] = Conv2D(1024, 1, activation='relu',
                        padding='same', name='fc7')(net['fc6'])
    # x = Dropout(0.5, name='drop7')(x)
    # Block 6
    net['conv6_1'] = Conv2D(256, 1, activation='relu',
                            padding='same',
                                   name='conv6_1')(net['fc7'])
    net['conv6_2'] = Conv2D(512, 3, strides=(2, 2),
                                   activation='relu', padding='same',
                                   name='conv6_2')(net['conv6_1'])
    # Block 7
    net['conv7_1'] =Conv2D(128, 1,activation='relu',
                           padding='same',
                                   name='conv7_1')(net['conv6_2'])
    net['conv7_2'] = ZeroPadding2D()(net['conv7_1'])
    net['conv7_2'] = Conv2D(256, 3, strides=(2, 2),
                                   activation='relu', padding='valid',
                                   name='conv7_2')(net['conv7_2'])
    # Block 8
    net['conv8_1'] = Conv2D(128, 3,activation='relu',
                            padding='same',
                                   name='conv8_1')(net['conv7_2'])
    net['conv8_2'] = Conv2D(256, 3, strides=(2, 2),
                                   activation='relu', padding='same',
    ...
    num_priors = 3
    x = Conv2D(num_priors * 4, 3, padding='same',
    ...
    # Prediction from fc7
    num_priors = 6
    net['fc7_mbox_loc'] =Conv2D(num_priors * 4, 3,
                                padding='same',
