...
flags.DEFINE_string('input_model', 'F:\\keras_project\\SSD300_keras\\premodel\\model.hdf5', 'Path to the input model.')#设定
...
flags.DEFINE_string('output_model', 'F:\\keras_project\\SSD300_keras\\premodel\\ssd.pb', 'Path where the converted model will be stored.')#设定
